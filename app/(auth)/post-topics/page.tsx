  ...
  return (
    <div className="p-6">
      <div className="mb-6 flex justify-between items-center">
        <h1 className={Typography.Headline}>Tópicos de Receitas</h1>
        <FilledButton
          text="+ Novo Tópico"
      ...
      <Table<PostTopic>
        ...
        onEdit={(topic) => router.push(routes.postCategories.update(topic.id))}
        onDelete={(topic) => {
      ...
      <ConfirmationModal
        ...
        message={`Tem certeza que deseja excluir a tópico "${selectedTopic?.name}"?`}
      />
    </div>
  );
}
